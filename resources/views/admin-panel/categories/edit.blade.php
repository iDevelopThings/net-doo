                ...
                <form action="/admin-panel/category" method="POST" class="grid" enctype="multipart/form-data">
                    ...
                    <div>
                        <div>
                            ...
                            <div class="mt-10">
                                <x-forms.multi-select-dropdown :items="$categories" oldValues="{{ $category->parent_categories->pluck('id') }}" text="Matične kategorije" name="parent_categories"></x-forms.multi-select-dropdown>
                            </div>

                            <div class="mt-2">
                                <x-forms.multi-select-dropdown :items="$categories" oldValues="{{ $category->child_categories->pluck('id') }}" text="Podkategorije" name="child_categories"></x-forms.multi-select-dropdown>
                            </div>
